...
local default_plugins = {
...

  {
    ...
    branch = "v2.0",
    lazy = false,
    config = function() require "nvchad_ui" end,
  },

  {
    "NvChad/nvterm",
    init = function() require("core.utils").load_mappings "nvterm" end,
...

  {
    ...
    init = function() require("core.utils").lazy_load "nvim-colorizer.lua" end,
    config = function(_, opts)
...

  {
    ...
    opts = function() return { override = require("nvchad_ui.icons").devicons } end,
    config = function(_, opts)
...

  {
    ...
    init = function() require("core.utils").lazy_load "indent-blankline.nvim" end,
...

  {
    ...
    opts = function() return require "plugins.configs.scope" end,
...
if #config.plugins > 0 then table.insert(default_plugins, { import = config.plugins }) end
