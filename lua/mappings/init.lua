...
map('n', '<CMD>', '<CMD>lua require("bufdelete").bufdelete(0, true)<CR>', opts)
...
map('n', '<CMD>', '<CMD>TmuxNavigateLeft<CR>', opts)
map('n', '<CMD>', '<CMD>TmuxNavigateRight<CR>', opts)
map('n', '<CMD>', '<CMD>TmuxNavigateDown<CR>', opts)
map('n', '<CMD>', '<CMD>TmuxNavigateUp<CR>', opts)
-- Misc
