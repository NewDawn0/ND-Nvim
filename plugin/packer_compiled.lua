...
_G.packer_plugins = {
  ...
  ["fzy-lua-native"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/fzy-lua-native",
  ...
  ["rainbow_parentheses.vim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/rainbow_parentheses.vim",
  ...
  ["vim-hug-neovim-rpc"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/vim-hug-neovim-rpc",
